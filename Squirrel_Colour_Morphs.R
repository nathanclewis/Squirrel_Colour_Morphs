...
{ #run this line to read all data files
  ...
  df_2021_completed <- read_csv("Data/sq_RGB_2021_1_27750.csv") %>%
...
df_2021_27751_28000 = df_2021_noerrors %>%
  #slice() %>%
  rowwise() %>%
...
df_2021_27751_28000_col <- df_2021_27751_28000 %>%
...
df_2021_new <- df_2021_completed %>%
  rbind(df_2021_27751_28000_col) #insert name of newly created df here
...
#write_csv(df_2021_new, "Data/sq_RGB_2021_1_28000.csv")
