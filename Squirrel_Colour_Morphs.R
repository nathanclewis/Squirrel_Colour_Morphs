...
{ #run this line to read all data files
  ...
  df_2021_completed <- read_csv("Data/sq_RGB_2021_1_29750.csv") %>%
...
df_2021_29751_30000 = df_2021_noerrors %>%
  #slice() %>%
  rowwise() %>%
...
df_2021_29751_30000_col <- df_2021_29751_30000 %>%
...
df_2021_new <- df_2021_completed %>%
  rbind(df_2021_29751_30000_col) #insert name of newly created df here
...
write_csv(df_2021_new, "Data/sq_RGB_2021_1_30000.csv")
