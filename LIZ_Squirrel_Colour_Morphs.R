...
df_2019_completed = read_csv("Data/sq_RGB_2019_1_3750.csv") 
...
df_2019_3751_4000 = df_2019_noerrors %>%
  #slice(1:3) %>% 
  rowwise() %>%
...
df_2019_3751_4000_col = df_2019_3751_4000 %>%
...
df_2019_new = df_2019_completed %>%
  rbind(df_2019_3751_4000_col) #insert name of newly created df here
...
write_csv(df_2019_new, "Data/sq_RGB_2019_1_4000.csv")
#write_csv(df_2019_3751_4000, "Data/df_2019_3751_4000.csv")
#df_2019_3751_4000 = read_csv("Data/df_2019_3751_4000.csv")
