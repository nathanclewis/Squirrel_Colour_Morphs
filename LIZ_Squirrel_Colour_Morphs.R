...
df_2019_completed = read_csv("Data/sq_RGB_2019_1_2500.csv") 
...
df_2019_2501_2750 = df_2019_noerrors %>%
  #slice(1:3) %>% 
  rowwise() %>%
...
df_2019_2501_2750_col = df_2019_2501_2750 %>%
...
df_2019_new = df_2019_completed %>%
  rbind(df_2019_2501_2750_col) #insert name of newly created df here
...
write_csv(df_2019_new, "Data/sq_RGB_2019_1_2750.csv")
