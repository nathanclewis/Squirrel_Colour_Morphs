...
df_2019_completed = read_csv("Data/sq_RGB_2019_1_2750.csv") 
...
df_2019_2751_3250 = df_2019_noerrors %>%
  #slice(1:3) %>% 
  rowwise() %>%
...
df_2019_2751_3250_col = df_2019_2751_3250 %>%
...
df_2019_new = df_2019_completed %>%
  rbind(df_2019_2751_3250_col) #insert name of newly created df here
...
write_csv(df_2019_new, "Data/sq_RGB_2019_1_3250.csv")
...
df_2019_1001_1500$mean_rgb <- map(results, "result")
df_2019_1001_1500$error    <- map(results, "error")

problem_rows <- df_2019_1001_1500 %>%
